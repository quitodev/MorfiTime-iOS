                            ...
                            VStack {
                                Button {
                                    ...
                                    let map = [
                                        ...
                                        "table": "Sin asignar todavía"
                                    ]
                                    bookingViewModel.updateBookings(map: map, userID: user.id, userPlace: user.place, userBookings: user.bookings)
                                } label: {
                                    HStack {
